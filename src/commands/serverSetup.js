...
Werewolf is a game with night and day cycles. During the night the werewolves will target a player to kill and during the day all players will vote on who they think is a werewolf. The night and day cycles are in real time. Night is at 8pm MST and day starts at 8am MST. Some characters will have special abilities that they can use in the game. There is three teams in werewolf the Villagers , Vampires, and the Werewolves. The Villagers want to find out who the Werewolves/Vampires are and hang them. The vampires want to kill the Werewolves and transform villagers into vampires. The Werewolves want to eat all the Villagers. The game will end when there is no more werewolves and vampires or the werewolves are grater or equal to the villagers/vampires or the vampires are grater than villagers/werewolves. When someone dies they will be given the Dead role. They can no longer help in the game but they can still watch in the after life.
