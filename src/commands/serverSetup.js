...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (!howToPlayChannel) {
      ...
      await howToPlayChannel.send(howToPlay5);
    }
...
**/mute** (player)
> This is the **Grouchy Granny** command. Use it in the town square channel. Can be used any time during the day. It will last the rest of the day and through the night. While the player is muted they will be able to leave massages on the out cast channel. The mute will be removed the next morning. This will stop a player from using a night power. eg (seer will not be able to use see or vampire will not be able to bite)
`;
